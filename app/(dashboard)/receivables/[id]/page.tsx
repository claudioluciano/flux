...
export default function ReceivableDetailPage({ params }: ReceivableDetailPageProps) {
  const { id } = use(params);
    ...
    return (
      <div className="space-y-6">
        ...
        <Link href="/receivables">
          <Button variant="outline">Voltar para Contas a Receber</Button>
        </Link>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Detalhes da conta a receber"
        action={
